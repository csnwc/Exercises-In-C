...
{\bf Rule $2$}: For a known square having the number $n$, with $u$ unknown and $m$ known mines in its
Moore neighbourhood, if $n = m + u$ and $u > 0$ then all unknown squares must be mines.
