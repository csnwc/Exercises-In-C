...
\nsection{Lecture Notes Chapter B}
\begin{exercise}
...
Note that these exercises are  in {\bf NO} particular order - try the ones you find easy before attempting more complex ones. Remember to code \verb^test()^ all your functions, where possible.
