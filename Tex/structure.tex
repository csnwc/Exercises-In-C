...
\node[draw=ocre!60,line width=1pt,circle,fill=ocre!25,font=\sffamily\bfseries,inner sep=2pt,outer sep=0pt] at (-25pt,0pt){\textcolor{ocre}{www}};\end{tikzpicture}} % Orange R in a circle
...
\begin{exercise}
After you've studied Chapter~#1 of the lecture notes ({\em #2}), compile and run the examples given in the handout.
\end{exercise} }%
